            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 p-6">
                        ...
                        <div class="bg-indigo-600 p-6 rounded-lg shadow-lg transform hover:scale-105 transition-transform">
                        ...
                        <div class="bg-emerald-600 p-6 rounded-lg shadow-lg transform hover:scale-105 transition-transform">
                        ...
                        <div class="bg-gray-600 p-6 rounded-lg shadow-lg transform hover:scale-105 transition-transform">
                            ...
                            <form method="POST" action="{{ route('admin.categories.store') }}">
                                ...
                                <div class="flex items-center justify-end mt-4">
                                    <x-primary-button class="ml-3 bg-indigo-600 text-white">
                                        {{ __('Agregar Categoría') }}
                                    </x-primary-button>
                                </div>
                            </form>
                            <div class="flex items-center justify-end mt-4">
                                <a href="{{ route('admin.categories.index') }}" class="ml-3 bg-indigo-600 text-white px-4 py-2 rounded-lg shadow-lg transform hover:scale-105 transition-transform">
                                    {{ __('Ver Categorías') }}
                                </a>
                            </div>
                        </div>
                        ...
                        @if (Auth::user()->isAdmin())
                        <div class="bg-orange-600 p-6 rounded-lg shadow-lg transform hover:scale-105 transition-transform">
                            ...
                            <div class="flex flex-col sm:flex-row justify-between space-y-2 sm:space-y-0 sm:space-x-2">
                                <a href="{{ route('tickets.pdf') }}" class="bg-gray-800 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded text-center">Generar PDF</a>
                                <a href="{{ route('tickets.pdf.preview') }}" class="bg-gray-800 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded text-center">Previsualizar PDF</a>
                            </div>
                        </div>
                        @endif
